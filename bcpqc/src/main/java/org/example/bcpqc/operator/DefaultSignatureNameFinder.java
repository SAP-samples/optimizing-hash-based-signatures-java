...
public class DefaultSignatureNameFinder
    ...
    static {
        ...
        oids.put(BCObjectIdentifiers.xmss_SHA256ph, "XMSS-SHA256");
        oids.put(BCObjectIdentifiers.xmss_SHA512ph, "XMSS-SHA512");
        oids.put(BCObjectIdentifiers.xmss_SHAKE128ph, "XMSS-SHAKE128");
        oids.put(BCObjectIdentifiers.xmss_SHAKE256ph, "XMSS-SHAKE256");
        oids.put(SAPBCObjectIdentifiers.xmss_SHA2_192ph, "XMSS-SHA2_192");
        oids.put(SAPBCObjectIdentifiers.xmss_SHAKE256_192ph, "XMSS-SHAKE256_192");
        oids.put(SAPBCObjectIdentifiers.xmss_SHAKE256_256ph, "XMSS-SHAKE256_256");

        oids.put(BCObjectIdentifiers.xmss_mt_SHA256ph, "XMSSMT-SHA256");
        oids.put(BCObjectIdentifiers.xmss_mt_SHA512ph, "XMSSMT-SHA512");
        oids.put(BCObjectIdentifiers.xmss_mt_SHAKE128ph, "XMSSMT-SHAKE128");
        oids.put(BCObjectIdentifiers.xmss_mt_SHAKE256ph, "XMSSMT-SHAKE256");
        oids.put(SAPBCObjectIdentifiers.xmss_mt_SHA2_192ph, "XMSSMT-SHA2_192");
        oids.put(SAPBCObjectIdentifiers.xmss_mt_SHAKE256_192ph, "XMSSMT-SHAKE256_192");
        oids.put(SAPBCObjectIdentifiers.xmss_mt_SHAKE256_256ph, "XMSSMT-SHAKE256_256");
