package org.example.bcpqc.operator.jcajce;
...
import org.example.bcpqc.operator.DefaultSignatureNameFinder;
...
class OperatorHelper {
    ...
    public X509Certificate convertCertificate(X509CertificateHolder certHolder)
        ...
        try {
            ...
            throw new OperatorHelper.OpCertificateException("cannot get encoded form of certificate: " + e.getMessage(), e);
        } catch (NoSuchProviderException e) {
            throw new OperatorHelper.OpCertificateException("cannot find factory provider: " + e.getMessage(), e);
        }
    }
