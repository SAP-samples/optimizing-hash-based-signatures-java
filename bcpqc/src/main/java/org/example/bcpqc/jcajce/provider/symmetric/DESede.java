package org.example.bcpqc.jcajce.provider.symmetric;
...
import org.example.bcpqc.jcajce.util.SAPBCJcaJceHelper;
...
public final class DESede {
    ...
    static public class SAPBCBaseBlockCipher extends BaseBlockCipher {

        protected SAPBCBaseBlockCipher(BlockCipher engine, int scheme, int digest, int keySizeInBits, int ivLength) {
            super(engine, scheme, digest, keySizeInBits, ivLength);
        }
        ...
        protected Key engineUnwrap(byte[] wrappedKey, String wrappedKeyAlgorithm, int wrappedKeyType) throws InvalidKeyException, NoSuchAlgorithmException {
            ...
            if (wrappedKeyType == Cipher.SECRET_KEY) {
                ...
                try {
                    ...
                    PrivateKey privKey = SAPBouncyCastleProvider.getPrivateKey(in);
                ...
                try {
                    ...
                    java.security.KeyFactory kf = (new SAPBCJcaJceHelper()).createKeyFactory(wrappedKeyAlgorithm);
    ...
    public static class Mappings
        ...
        private static final String PACKAGE = "org.example.bcpqc.jcajce.provider.symmetric"; // JDK 1.2
