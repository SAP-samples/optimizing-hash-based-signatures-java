package org.example.bcpqc.jcajce.provider.keystore.pkcs12;
...
public class PKCS12KeyStoreSpi
    ...
    private final JcaJceHelper helper = new SAPBCJcaJceHelper();
    ...
    public static class BCPKCS12KeyStore
        ...
        public BCPKCS12KeyStore() {
            super(new SAPBCJcaJceHelper(), new PKCS12KeyStoreSpi(new SAPBCJcaJceHelper(), pbeWithSHAAnd3_KeyTripleDES_CBC, pbeWithSHAAnd40BitRC2_CBC));
        }
    }
    ...
    public static class BCPKCS12KeyStore3DES
        ...
        public BCPKCS12KeyStore3DES() {
            super(new SAPBCJcaJceHelper(), new PKCS12KeyStoreSpi(new SAPBCJcaJceHelper(), pbeWithSHAAnd3_KeyTripleDES_CBC, pbeWithSHAAnd3_KeyTripleDES_CBC));
        }
    }
