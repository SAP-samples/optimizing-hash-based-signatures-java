package org.example.bcpqc.jcajce.provider.asymmetric.x509;
...
class PEMUtil {
    ...
    PEMUtil(String type) {
        _supportedBoundaries = new PEMUtil.Boundaries[]
    ...
    /**
     * Returns a {@link PEMUtil.Boundaries} object representing the passed in boundary
     * string.
     *
     * @param line the boundary string
     * @return the {@link PEMUtil.Boundaries} object corresponding to the given boundary
     * string or <code>null</code> if the passed in string is not a valid
     * boundary.
     */
    private PEMUtil.Boundaries getBoundaries(String line) {
