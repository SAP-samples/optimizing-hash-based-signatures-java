package org.example.bcpqc.jcajce.provider.asymmetric;
...
public class X509 {
    public static class Mappings
        ...
        public void configure(ConfigurableProvider provider) {
            ...
            //
            provider.addAlgorithm("CertificateFactory.X.509", "org.example.bcpqc.jcajce.provider.asymmetric.x509.CertificateFactory");
