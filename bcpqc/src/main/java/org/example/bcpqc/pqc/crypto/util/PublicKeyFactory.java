...
import org.example.bcpqc.pqc.crypto.lms.HSSPublicKeyParameters;
import org.example.bcpqc.pqc.crypto.lms.LMSPublicKeyParameters;
...
import org.example.bcpqc.pqc.crypto.xmss.XMSSMTParameters;
import org.example.bcpqc.pqc.crypto.xmss.XMSSMTPublicKeyParameters;
import org.example.bcpqc.pqc.crypto.xmss.XMSSParameters;
import org.example.bcpqc.pqc.crypto.xmss.XMSSPublicKeyParameters;
...
public class PublicKeyFactory {
    ...
    static {
        ...
        */
        converters.put(SAPBCObjectIdentifiers.sphincsPlus, new SPHINCSPlusConverter());
        converters.put(SAPBCObjectIdentifiers.sphincsPlus_shake_256, new SPHINCSPlusConverter());
        converters.put(SAPBCObjectIdentifiers.sphincsPlus_sha_256, new SPHINCSPlusConverter());
        converters.put(SAPBCObjectIdentifiers.sphincsPlus_sha_512, new SPHINCSPlusConverter());
        /*
        ...
        extends SubjectPublicKeyInfoConverter
    {
        AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo keyInfo, Object defaultParams)
            throws IOException
        {
            return new QTESLAPublicKeyParameters(org.bouncycastle.pqc.crypto.util.Utils.qTeslaLookupSecurityCategory(keyInfo.getAlgorithm()), keyInfo.getPublicKeyData().getOctets());
        }
    }
        ...
        extends SubjectPublicKeyInfoConverter
    {
            ...
            throws IOException
        {
            return new SPHINCSPublicKeyParameters(keyInfo.getPublicKeyData().getBytes(),
                org.bouncycastle.pqc.crypto.util.Utils.sphincs256LookupTreeAlgName(SPHINCS256KeyParams.getInstance(keyInfo.getAlgorithm().getParameters())));
        }
    }
        ...
        extends SubjectPublicKeyInfoConverter
    {
            ...
            throws IOException
        {
            ...
            CMCEParameters spParams = org.bouncycastle.pqc.crypto.util.Utils.mcElieceParamsLookup(keyInfo.getAlgorithm().getAlgorithm());
            ...
            extends SubjectPublicKeyInfoConverter
    {
                ...
                throws IOException
        {
            ...
            SABERParameters saberParams = org.bouncycastle.pqc.crypto.util.Utils.saberParamsLookup(keyInfo.getAlgorithm().getAlgorithm());
        ...
        extends SubjectPublicKeyInfoConverter
    {
            ...
            throws IOException
        {
            ...
            return new McElieceCCA2PublicKeyParameters(mKey.getN(), mKey.getT(), mKey.getG(), org.bouncycastle.pqc.crypto.util.Utils.getDigestName(mKey.getDigest().getAlgorithm()));
        }
    }
            ...
            extends SubjectPublicKeyInfoConverter
    {
                ...
                throws IOException
        {
            ...
            FrodoParameters fParams = org.bouncycastle.pqc.crypto.util.Utils.frodoParamsLookup(keyInfo.getAlgorithm().getAlgorithm());
