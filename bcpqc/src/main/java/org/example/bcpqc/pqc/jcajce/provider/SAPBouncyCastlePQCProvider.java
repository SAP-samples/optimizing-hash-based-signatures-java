...
public class SAPBouncyCastlePQCProvider
        extends Provider
        implements ConfigurableProvider {
    private static String info = "BouncyCastle Post-Quantum Security Provider v1.71";

    public static String PROVIDER_NAME = "SAPBCPQC";
     ...
     */
    private static final String ALGORITHM_PACKAGE = "org.example.bcpqc.pqc.jcajce.provider.";
     ...
     */
    public SAPBouncyCastlePQCProvider() {
    ...
    private void loadAlgorithms(String packageName, String[] names) {
        for (int i = 0; i != names.length; i++) {
            Class clazz = loadClass(SAPBouncyCastlePQCProvider.class, packageName + names[i] + "$Mappings");
