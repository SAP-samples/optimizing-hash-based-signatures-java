...
import org.example.bcpqc.pqc.crypto.lms.*;
...
public class LMSKeyPairGeneratorSpi
    ...
    public KeyPair generateKeyPair() {
        if (!initialised) {
            param = new LMSKeyGenerationParameters(new LMSParameters(LMSigParameters.lms_sha256_m32_h10, LMOtsParameters.sha256_n32_w2), random);
