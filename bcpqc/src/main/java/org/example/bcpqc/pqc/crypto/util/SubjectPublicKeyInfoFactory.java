...
import org.example.bcpqc.pqc.crypto.lms.Composer;
...
public class SubjectPublicKeyInfoFactory {
    ...
    public static SubjectPublicKeyInfo createSubjectPublicKeyInfo(AsymmetricKeyParameter publicKey)
        ...
        if (publicKey instanceof QTESLAPublicKeyParameters)
        {
            ...
            AlgorithmIdentifier algorithmIdentifier = org.bouncycastle.pqc.crypto.util.Utils.qTeslaLookupAlgID(keyParams.getSecurityCategory());
        ...
        else if (publicKey instanceof SPHINCSPublicKeyParameters)
        {
            ...
            AlgorithmIdentifier algorithmIdentifier = new AlgorithmIdentifier(PQCObjectIdentifiers.sphincs256,
                new SPHINCS256KeyParams(org.bouncycastle.pqc.crypto.util.Utils.sphincs256LookupTreeAlgID(params.getTreeDigest())));
        ...
        */
        ...
        else if (publicKey instanceof CMCEPublicKeyParameters)
        {
            ...
            AlgorithmIdentifier algorithmIdentifier = new AlgorithmIdentifier(org.bouncycastle.pqc.crypto.util.Utils.mcElieceOidLookup(params.getParameters()));
            ...
            if (keyEnc.length > publicSeed.length + root.length) {
                ...
                AlgorithmIdentifier algorithmIdentifier = new AlgorithmIdentifier(PQCObjectIdentifiers.xmss,
                        new XMSSKeyParams(keyParams.getParameters().getHeight(), Utils.xmssLookupTreeAlgID(keyParams.getTreeDigest()), keyParams.getParameters().getTreeDigestSize()));
            ...
            if (keyEnc.length > publicSeed.length + root.length) {
                ...
                AlgorithmIdentifier algorithmIdentifier = new AlgorithmIdentifier(PQCObjectIdentifiers.xmss_mt, new XMSSMTKeyParams(keyParams.getParameters().getHeight(), keyParams.getParameters().getLayers(),
                        Utils.xmssLookupTreeAlgID(keyParams.getTreeDigest()), keyParams.getParameters().getTreeDigestSize()));
        ...
        else if (publicKey instanceof McElieceCCA2PublicKeyParameters)
        {
            ...
            McElieceCCA2PublicKey mcEliecePub = new McElieceCCA2PublicKey(pub.getN(), pub.getT(), pub.getG(), org.bouncycastle.pqc.crypto.util.Utils.getAlgorithmIdentifier(pub.getDigest()));
        ...
        else if (publicKey instanceof FrodoPublicKeyParameters)
        {
            ...
            AlgorithmIdentifier algorithmIdentifier = new AlgorithmIdentifier(org.bouncycastle.pqc.crypto.util.Utils.frodoOidLookup(params.getParameters()));
        ...
        else if (publicKey instanceof SABERPublicKeyParameters)
        {
            ...
            AlgorithmIdentifier algorithmIdentifier = new AlgorithmIdentifier(org.bouncycastle.pqc.crypto.util.Utils.saberOidLookup(params.getParameters()));
