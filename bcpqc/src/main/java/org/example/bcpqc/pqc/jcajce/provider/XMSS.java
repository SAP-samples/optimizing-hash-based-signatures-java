...
import org.example.bcpqc.pqc.jcajce.provider.xmss.XMSSKeyFactorySpi;
import org.example.bcpqc.pqc.jcajce.provider.xmss.XMSSMTKeyFactorySpi;

public class XMSS {
    private static final String PREFIX = "org.example.bcpqc.pqc.jcajce.provider" + ".xmss.";
    ...
    public static class Mappings
        ...
        public void configure(ConfigurableProvider provider) {
            ...
            addSignatureAlgorithm(provider, "XMSS-SHA2_192", PREFIX + "XMSSSignatureSpi$withSha2_192", SAPBCObjectIdentifiers.xmss_SHA2_192);
            addSignatureAlgorithm(provider, "XMSS-SHAKE256_256", PREFIX + "XMSSSignatureSpi$withShake256_256", SAPBCObjectIdentifiers.xmss_SHAKE256_256);
            addSignatureAlgorithm(provider, "XMSS-SHAKE256_192", PREFIX + "XMSSSignatureSpi$withShake256_192", SAPBCObjectIdentifiers.xmss_SHAKE256_192);
            ...
            addSignatureAlgorithm(provider, "SHA2_192", "XMSS-SHA2_192", PREFIX + "XMSSSignatureSpi$withSha2_192andPrehash", SAPBCObjectIdentifiers.xmss_SHA2_192ph);
            addSignatureAlgorithm(provider, "SHAKE256_256", "XMSS-SHAKE256_256", PREFIX + "XMSSSignatureSpi$withShake256_256andPrehash", SAPBCObjectIdentifiers.xmss_SHAKE256_256ph);
            addSignatureAlgorithm(provider, "SHAKE256_192", "XMSS-SHAKE256_192", PREFIX + "XMSSSignatureSpi$withShake256_192andPrehash", SAPBCObjectIdentifiers.xmss_SHAKE256_192ph);
            ...
            provider.addAlgorithm("Alg.Alias.Signature.SHA2_192WITHXMSS", "SHA2_192WITHXMSS-SHA2_192");
            provider.addAlgorithm("Alg.Alias.Signature.SHAKE256_256WITHXMSS", "SHAKE256_256WITHXMSS-SHAKE256_256");
            provider.addAlgorithm("Alg.Alias.Signature.SHAKE256_192WITHXMSS", "SHAKE256_192WITHXMSS-SHAKE256_192");
            ...
            addSignatureAlgorithm(provider, "XMSSMT-SHA2_192", PREFIX + "XMSSMTSignatureSpi$withSha2_192", SAPBCObjectIdentifiers.xmss_mt_SHA2_192);
            addSignatureAlgorithm(provider, "XMSSMT-SHAKE256_256", PREFIX + "XMSSMTSignatureSpi$withShake256_256", SAPBCObjectIdentifiers.xmss_mt_SHAKE256_256);
            addSignatureAlgorithm(provider, "XMSSMT-SHAKE256_192", PREFIX + "XMSSMTSignatureSpi$withShake256_192", SAPBCObjectIdentifiers.xmss_mt_SHAKE256_192);
