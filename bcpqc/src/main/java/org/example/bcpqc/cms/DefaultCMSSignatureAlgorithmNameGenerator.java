...
//        addEntries(GMObjectIdentifiers.sm2sign_with_sha512, "SHA512", "SM2");
        ...
        addEntries(BCObjectIdentifiers.xmss_SHA256ph, "SHA256", "XMSS");
        addEntries(BCObjectIdentifiers.xmss_SHA512ph, "SHA512", "XMSS");
        addEntries(BCObjectIdentifiers.xmss_SHAKE128ph, "SHAKE128", "XMSS");
        addEntries(BCObjectIdentifiers.xmss_SHAKE256ph, "SHAKE256", "XMSS");
        addEntries(SAPBCObjectIdentifiers.xmss_SHA2_192ph, "SHA2_192", "XMSS");
        addEntries(SAPBCObjectIdentifiers.xmss_SHAKE256_192ph, "SHAKE256_192", "XMSS");
        addEntries(SAPBCObjectIdentifiers.xmss_SHAKE256_256ph, "SHAKE256_256", "XMSS");

        addEntries(BCObjectIdentifiers.xmss_mt_SHA256ph, "SHA256", "XMSSMT");
        addEntries(BCObjectIdentifiers.xmss_mt_SHA512ph, "SHA512", "XMSSMT");
        addEntries(BCObjectIdentifiers.xmss_mt_SHAKE128ph, "SHAKE128", "XMSSMT");
        addEntries(BCObjectIdentifiers.xmss_mt_SHAKE256ph, "SHAKE256", "XMSSMT");
        addEntries(SAPBCObjectIdentifiers.xmss_mt_SHA2_192ph, "SHA2_192", "XMSSMT");
        addEntries(SAPBCObjectIdentifiers.xmss_mt_SHAKE256_192ph, "SHAKE256_192", "XMSSMT");
        addEntries(SAPBCObjectIdentifiers.xmss_mt_SHAKE256_256ph, "SHAKE256_256", "XMSSMT");
