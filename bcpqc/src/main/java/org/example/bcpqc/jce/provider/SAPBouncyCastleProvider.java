package org.example.bcpqc.jce.provider;
...
import org.example.bcpqc.pqc.jcajce.provider.lms.LMSKeyFactorySpi;
 ...
 */
public final class SAPBouncyCastleProvider extends Provider
        implements ConfigurableProvider {
    private static String info = "BouncyCastle Security Provider v1.70";

    public static final String PROVIDER_NAME = "SAPBC";

    public static final ProviderConfiguration CONFIGURATION = new BouncyCastleProviderConfiguration();

    private static final Map keyInfoConverters = new HashMap();

    private static final Class revChkClass = ClassUtil.loadClass(SAPBouncyCastleProvider.class, "java.security.cert.PKIXRevocationChecker");
    ...
    private static final String[] SAPBC_SYMMERTRIC_CIPHERS = {"DESede"};
    private static final String SAPBC_SYMMETRIC_PACKAGE = "org.example.bcpqc.jcajce.provider.symmetric.";

    private static final String PQC_ALGORITHM_PACKAGE = "org.example.bcpqc.pqc.jcajce.provider.";
    private static final String[] PQC_ALGORITHMS =
            {
                    //"Rainbow", "McEliece", "SPHINCS",
                    "LMS",
                    // "NH", "XMSS", "SPHINCSPlus", "CMCE", "Frodo", "SABER"
                    "XMSS"
            };
    ...
    private static final String SAPBC_ASYMMETRIC_PACKAGE = "org.example.bcpqc.jcajce.provider.asymmetric.";
    private static final String[] SAPBC_ASYMMETRIC_GENERIC =
            {
                    "X509"
            };
     ...
     */
    private static final String KEYSTORE_PACKAGE = "org.example.bcpqc.jcajce.provider.keystore.";
     ...
     */
    public SAPBouncyCastleProvider() {
    ...
    private void setup() {
        ...
        loadAlgorithms(SAPBC_SYMMETRIC_PACKAGE, SAPBC_SYMMERTRIC_CIPHERS);

        loadAlgorithms(SAPBC_ASYMMETRIC_PACKAGE, SAPBC_ASYMMETRIC_GENERIC);
    ...
    private void loadAlgorithms(String packageName, String[] names) {
        for (int i = 0; i != names.length; i++) {
            Class clazz = ClassUtil.loadClass(SAPBouncyCastleProvider.class, packageName + names[i] + "$Mappings");
