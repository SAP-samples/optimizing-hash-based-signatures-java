...
public class XMSSMTTest
    ...
    public void test160PrivateKeyRecovery()
        throws Exception
    {
        KeyFactory kFact = KeyFactory.getInstance("XMSSMT", "SAPBCPQC");
    ...
    public void testKeyExtraction()
            throws Exception {
        KeyPairGenerator kpg = KeyPairGenerator.getInstance("XMSSMT", "SAPBCPQC");

        kpg.initialize(new XMSSMTParameterSpec(20, 2, XMSSMTParameterSpec.SHA256), new SecureRandom());

        KeyPair kp = kpg.generateKeyPair();

        StateAwareSignature sig = (StateAwareSignature) Signature.getInstance("XMSSMT-SHA256", "SAPBCPQC");
    ...
    public void testXMSSMTSha256SignatureMultiple()
        ...
        StateAwareSignature sig1 = (StateAwareSignature) Signature.getInstance("SHA256withXMSSMT-SHA256", "SAPBCPQC");

        StateAwareSignature sig2 = (StateAwareSignature) Signature.getInstance("SHA256withXMSSMT-SHA256", "SAPBCPQC");

        StateAwareSignature sig3 = (StateAwareSignature) Signature.getInstance("SHA256withXMSSMT-SHA256", "SAPBCPQC");
    ...
    public void testXMSSMTSha512KeyFactory()
        ...
        KeyFactory keyFactory = KeyFactory.getInstance("XMSSMT", "SAPBCPQC");
    ...
    public void testXMSSMTSha256Signature()
            throws Exception {
        testSignature(XMSSMTParameterSpec.SHA256, "SHA256withXMSSMT");
    }

    public void testXMSSMTSha512Signature()
            throws Exception {
        testSignature(XMSSMTParameterSpec.SHA512,"SHA256withXMSSMT");
    }

    public void testXMSSMTShake128Signature()
            throws Exception {
        testSignature(XMSSMTParameterSpec.SHAKE128, "XMSSMT-SHAKE128");
    }

    public void testXMSSMTShake256Signature()
            throws Exception {
        testSignature(XMSSMTParameterSpec.SHAKE256, "XMSSMT-SHAKE256");
    }

    public void testXMSSMTSha2_192Signature() throws Exception {
        testSignature(XMSSMTParameterSpec.SHA2_192, "XMSSMT-SHA2_192");
    }

    public void testXMSSMTShake256_256Signature() throws Exception {
        testSignature(XMSSMTParameterSpec.SHAKE256_256, "XMSSMT-SHAKE256_256");
    }

    public void testXMSSMTShake256_192Signature() throws Exception {
        testSignature(XMSSMTParameterSpec.SHAKE256_192, "XMSSMT-SHAKE256_192");
    }
    ...
    private void testSignature(String digest, String algorithm) throws Exception {
        ...
        kpg.initialize(new XMSSMTParameterSpec(4, 2, digest), new SecureRandom());

        KeyPair kp = kpg.generateKeyPair();

        Signature sig = Signature.getInstance(algorithm, "SAPBCPQC");
    ...
    public void testKeyRebuild()
        ...
        Signature sig = Signature.getInstance("SHA256withXMSSMT", "SAPBCPQC");
    ...
    public void testXMSSMTSha2_192KeyFactory()
            throws Exception {
        KeyPairGenerator kpg = KeyPairGenerator.getInstance("XMSSMT", "SAPBCPQC");

        kpg.initialize(new XMSSMTParameterSpec(20, 2, XMSSMTParameterSpec.SHA2_192), new SecureRandom());
        ...
        testSig("XMSSMT-SHA2_192", pubKey, (PrivateKey) privKey);
    }

    public void testXMSSMTShake256_192KeyFactory()
            throws Exception {
        KeyPairGenerator kpg = KeyPairGenerator.getInstance("XMSSMT", "SAPBCPQC");

        kpg.initialize(new XMSSMTParameterSpec(20, 2, XMSSMTParameterSpec.SHAKE256_192), new SecureRandom());
        ...
        assertEquals(20, privKey.getHeight());
        assertEquals(XMSSMTParameterSpec.SHAKE256, privKey.getTreeDigest());

        testSig("XMSSMT-SHAKE256_192", pubKey, (PrivateKey) privKey);
    }
    ...
    private void testSig(String algorithm, PublicKey pubKey, PrivateKey privKey)
        ...
        Signature s1 = Signature.getInstance(algorithm, "SAPBCPQC");
        Signature s2 = Signature.getInstance(algorithm, "SAPBCPQC");
    ...
    public void testExhaustion()
            throws Exception {
        StateAwareSignature s1 = (StateAwareSignature) Signature.getInstance(BCObjectIdentifiers.xmss_mt_SHA256.getId(), "SAPBCPQC");
        Signature s2 = Signature.getInstance(BCObjectIdentifiers.xmss_mt_SHA256.getId(), "SAPBCPQC");
    ...
    public void testNoRepeats()
        ...
        Signature sigGen = Signature.getInstance(BCObjectIdentifiers.xmss_mt_SHA256.getId(), "SAPBCPQC");
        Signature sigVer = Signature.getInstance(BCObjectIdentifiers.xmss_mt_SHA256.getId(), "SAPBCPQC");
    ...
    public void testShardedKeyExhaustion()
            throws Exception {
        Signature s1 = Signature.getInstance(BCObjectIdentifiers.xmss_mt_SHA256.getId(), "SAPBCPQC");
        Signature s2 = Signature.getInstance(BCObjectIdentifiers.xmss_mt_SHA256.getId(), "SAPBCPQC");
    ...
    private void exhaustKey(
        ...
        KeyFactory keyFact = KeyFactory.getInstance("XMSSMT", "SAPBCPQC");
    ...
    public void testReserialization()
        ...
        for (int i = 0; i != 10; i++) {
            StateAwareSignature signer = (StateAwareSignature) Signature.getInstance(sigAlg, "SAPBCPQC");
