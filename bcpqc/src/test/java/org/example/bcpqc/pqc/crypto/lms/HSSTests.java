...
public class HSSTests
    ...
    public void testHssKeySerialisation()
        ...
        HSSPrivateKeyParameters generatedPrivateKey = HSS.generateHSSKeyPair(
                new HSSKeyGenerationParameters(new LMSParameters[]{
                        new LMSParameters(LMSigParameters.lms_sha256_m32_h5, LMOtsParameters.sha256_n32_w4),
                        new LMSParameters(LMSigParameters.lms_sha256_m32_h5, LMOtsParameters.sha256_n32_w2),
                }, rand)
        );
    ...
    public void testHSSVector_1()
            throws Exception {
        ArrayList<byte[]> blocks = loadVector("/org/example/bcpqc/pqc/crypto/test/lms/testcase_1.txt");
    ...
    public void testHSSVector_2()
        ...
        ArrayList<byte[]> blocks = loadVector("/org/example/bcpqc/pqc/crypto/test/lms/testcase_2.txt");
    ...
    public void testVectorsFromReference()
        ...
        String[] lines = new String(Streams.readAll(HSSTests.class.getResourceAsStream("/org/example/bcpqc/pqc/crypto/test/lms/depth_1.txt"))).split("\n");
    ...
    public void testVectorsFromReference_Expanded()
        ...
        String[] lines = new String(Streams.readAll(HSSTests.class.getResourceAsStream("/org/example/bcpqc/pqc/crypto/test/lms/expansion.txt"))).split("\n");
    ...
    public void testSignUnitExhaustion()
        ...
        HSSPrivateKeyParameters keyPair = HSS.generateHSSKeyPair(
                new HSSKeyGenerationParameters(new LMSParameters[]{
                        new LMSParameters(LMSigParameters.lms_sha256_m32_h5, LMOtsParameters.sha256_n32_w2),
                        new LMSParameters(LMSigParameters.lms_sha256_m32_h10, LMOtsParameters.sha256_n32_w1),
                }, rand)
        );
        ...
        try {
            while (ctr < 32769) // Just a number..
            {
                ...
                if (ctr % mod == 0) {
                    ...
                    assertTrue(sig.getSignature().getParameter().getType() == LMSigParameters.lms_sha256_m32_h10.getType());
